  ...
  constructor(props: any) {
    ...
    this.state = {
      data: [
        {
          time: "18.01.2021",
          body: "«Норникель» обеспечит бесплатными тестамина коронавирус всех приезжающих в Норильск поддержит стартапы Заполярья",
        },
        {
          time: "20.08.2021",
          body: "«Норникель» обеспечит бесплатными тестамина коронавирус всех приезжающих в Норильск",
        },
      ],
